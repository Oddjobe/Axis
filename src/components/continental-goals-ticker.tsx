...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 59973, unit: "$/MT", trend: "+", change: 0.42 },
    ...
    { id: "CC", title: "COCOA (ICE)", price: 8730, unit: "$/MT", trend: "+", change: 0.95 },
    { id: "BR", title: "BRENT CRUDE", price: 91.35, unit: "$/BBL", trend: "+", change: 1.31 },
