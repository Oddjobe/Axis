...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 57895, unit: "$/MT", trend: "+", change: 0.42 },
    ...
    { id: "BR", title: "BRENT CRUDE", price: 93.11, unit: "$/BBL", trend: "+", change: 1.31 },
    { id: "PT", title: "PLATINUM", price: 930, unit: "$/OZ", trend: "+", change: 0.71 },
    { id: "UR", title: "URANIUM (U3O8)", price: 95.78, unit: "$/LB", trend: "+", change: 1.69 },
    { id: "PD", title: "PALLADIUM", price: 1037, unit: "$/OZ", trend: "+", change: 1.25 },
