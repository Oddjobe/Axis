...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 57586, unit: "$/MT", trend: "+", change: 0.42 },
    { id: "LI", title: "LITHIUM CARBONATE", price: 24014, unit: "$/MT", trend: "+", change: 1.12 },
    { id: "AU", title: "GOLD (SPOT)", price: 5279, unit: "$/OZ", trend: "+", change: 0.45 },
    ...
    { id: "UR", title: "URANIUM (U3O8)", price: 95.45, unit: "$/LB", trend: "+", change: 1.69 },
