...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 57064, unit: "$/MT", trend: "+", change: 0.42 },
    { id: "LI", title: "LITHIUM CARBONATE", price: 23040, unit: "$/MT", trend: "+", change: 1.12 },
    { id: "AU", title: "GOLD (SPOT)", price: 5193, unit: "$/OZ", trend: "+", change: 0.45 },
    ...
    { id: "UR", title: "URANIUM (U3O8)", price: 97.38, unit: "$/LB", trend: "+", change: 1.69 },
