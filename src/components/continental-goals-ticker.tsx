...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 56684, unit: "$/MT", trend: "+", change: 0.42 },
    { id: "LI", title: "LITHIUM CARBONATE", price: 23580, unit: "$/MT", trend: "+", change: 1.12 },
    ...
    { id: "BR", title: "BRENT CRUDE", price: 94.16, unit: "$/BBL", trend: "+", change: 1.31 },
