...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 59452, unit: "$/MT", trend: "+", change: 0.42 },
    ...
    { id: "BR", title: "BRENT CRUDE", price: 91.58, unit: "$/BBL", trend: "+", change: 1.31 },
    { id: "PT", title: "PLATINUM", price: 912, unit: "$/OZ", trend: "+", change: 0.71 },
    { id: "UR", title: "URANIUM (U3O8)", price: 96.89, unit: "$/LB", trend: "+", change: 1.69 },
