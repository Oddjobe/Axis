...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 56519, unit: "$/MT", trend: "+", change: 0.42 },
    { id: "LI", title: "LITHIUM CARBONATE", price: 23506, unit: "$/MT", trend: "+", change: 1.12 },
    { id: "AU", title: "GOLD (SPOT)", price: 5140, unit: "$/OZ", trend: "+", change: 0.45 },
