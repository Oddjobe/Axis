...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 57315, unit: "$/MT", trend: "+", change: 0.42 },
    { id: "LI", title: "LITHIUM CARBONATE", price: 23970, unit: "$/MT", trend: "+", change: 1.12 },
    { id: "AU", title: "GOLD (SPOT)", price: 5139, unit: "$/OZ", trend: "+", change: 0.45 },
    { id: "CU", title: "COPPER (COMEX)", price: 5.78, unit: "$/LB", trend: "+", change: 1.37 },
    { id: "CC", title: "COCOA (ICE)", price: 8734, unit: "$/MT", trend: "+", change: 0.95 },
    { id: "BR", title: "BRENT CRUDE", price: 93.42, unit: "$/BBL", trend: "+", change: 1.31 },
    { id: "PT", title: "PLATINUM", price: 899, unit: "$/OZ", trend: "+", change: 0.71 },
    { id: "UR", title: "URANIUM (U3O8)", price: 96.68, unit: "$/LB", trend: "+", change: 1.69 },
    { id: "PD", title: "PALLADIUM", price: 1050, unit: "$/OZ", trend: "+", change: 1.25 },
    { id: "NG", title: "NATURAL GAS", price: 2.52, unit: "$/MMBtu", trend: "+", change: 2.9 }
];
