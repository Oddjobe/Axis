...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 58310, unit: "$/MT", trend: "+", change: 0.42 },
    { id: "LI", title: "LITHIUM CARBONATE", price: 23831, unit: "$/MT", trend: "+", change: 1.12 },
    { id: "AU", title: "GOLD (SPOT)", price: 5221, unit: "$/OZ", trend: "+", change: 0.45 },
    ...
    { id: "PT", title: "PLATINUM", price: 921, unit: "$/OZ", trend: "+", change: 0.71 },
    { id: "UR", title: "URANIUM (U3O8)", price: 95.90, unit: "$/LB", trend: "+", change: 1.69 },
