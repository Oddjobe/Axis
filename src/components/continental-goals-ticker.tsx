...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 58341, unit: "$/MT", trend: "+", change: 0.42 },
    ...
    { id: "CC", title: "COCOA (ICE)", price: 8669, unit: "$/MT", trend: "+", change: 0.95 },
    { id: "BR", title: "BRENT CRUDE", price: 92.07, unit: "$/BBL", trend: "+", change: 1.31 },
