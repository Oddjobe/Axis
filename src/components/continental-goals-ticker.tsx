...
const INITIAL_COMMODITIES = [
    { id: "CO", title: "COBALT (LME)", price: 57822, unit: "$/MT", trend: "+", change: 0.42 },
    { id: "LI", title: "LITHIUM CARBONATE", price: 23963, unit: "$/MT", trend: "+", change: 1.12 },
    ...
    { id: "BR", title: "BRENT CRUDE", price: 94.18, unit: "$/BBL", trend: "+", change: 1.31 },
    { id: "PT", title: "PLATINUM", price: 935, unit: "$/OZ", trend: "+", change: 0.71 },
    { id: "UR", title: "URANIUM (U3O8)", price: 95.77, unit: "$/LB", trend: "+", change: 1.69 },
