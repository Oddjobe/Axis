...
const COUNTRY_LABELS: { name: string, code: string, coordinates: [number, number], size?: string }[] = [
    { name: "NIGERIA", code: "NGA", coordinates: [8, 9.5] },
    { name: "EGYPT", code: "EGY", coordinates: [30, 27] },
    { name: "S. AFRICA", code: "ZAF", coordinates: [25, -30] },
    { name: "KENYA", code: "KEN", coordinates: [38, 0] },
    { name: "DRC", code: "COD", coordinates: [23, -3] },
    { name: "ETHIOPIA", code: "ETH", coordinates: [39, 8.5] },
    { name: "ALGERIA", code: "DZA", coordinates: [3, 28], size: "lg" },
    { name: "MOROCCO", code: "MAR", coordinates: [-6, 32] },
    { name: "GHANA", code: "GHA", coordinates: [-1.5, 7.5] },
    { name: "TANZANIA", code: "TZA", coordinates: [35, -6.5] },
    { name: "ANGOLA", code: "AGO", coordinates: [17.5, -12] },
    { name: "SUDAN", code: "SDN", coordinates: [30, 15] },
    { name: "LIBYA", code: "LBY", coordinates: [17, 27], size: "lg" },
    { name: "MALI", code: "MLI", coordinates: [-2, 17] },
    { name: "NIGER", code: "NER", coordinates: [9, 17] },
    { name: "CHAD", code: "TCD", coordinates: [18, 13] },
    { name: "SENEGAL", code: "SEN", coordinates: [-15, 14.5] },
    { name: "MOZAMBIQUE", code: "MOZ", coordinates: [35, -17] },
    { name: "ZAMBIA", code: "ZMB", coordinates: [28, -14] },
    { name: "ZIMBABWE", code: "ZWE", coordinates: [30, -20] },
    { name: "MADAGASCAR", code: "MDG", coordinates: [47, -19.5] },
    { name: "CAMEROON", code: "CMR", coordinates: [12, 6] },
    { name: "SOMALIA", code: "SOM", coordinates: [46, 5] },
    { name: "UGANDA", code: "UGA", coordinates: [32, 1.5] },
    { name: "RWANDA", code: "RWA", coordinates: [29.5, -2] },
    { name: "TUNISIA", code: "TUN", coordinates: [9.5, 34] },
    { name: "NAMIBIA", code: "NAM", coordinates: [17, -22] },
    { name: "BOTSWANA", code: "BWA", coordinates: [24, -22.5] },
    { name: "MAURITANIA", code: "MRT", coordinates: [-10, 20] },
    { name: "GABON", code: "GAB", coordinates: [11.5, -0.5] },
    { name: "CONGO", code: "COG", coordinates: [15, -4] },
    { name: "GUINEA", code: "GIN", coordinates: [-11, 10.5] },
    { name: "BENIN", code: "BEN", coordinates: [2.3, 9.5] },
    { name: "TOGO", code: "TGO", coordinates: [1.1, 8.5] },
    { name: "S. LEONE", code: "SLE", coordinates: [-11.5, 8.5] },
    { name: "LIBERIA", code: "LBR", coordinates: [-9.5, 6.5] },
    { name: "CÔTE D'IV.", code: "CIV", coordinates: [-5.5, 7.5] },
    { name: "BURKINA F.", code: "BFA", coordinates: [-1.5, 12.5] },
    { name: "S. SUDAN", code: "SSD", coordinates: [31, 7] },
    { name: "ERITREA", code: "ERI", coordinates: [39, 15] },
    { name: "C.A.R.", code: "CAF", coordinates: [20, 6.5] },
    { name: "ESWATINI", code: "SWZ", coordinates: [31.5, -26.5] },
    { name: "LESOTHO", code: "LSO", coordinates: [28.5, -29.5] },
    { name: "MALAWI", code: "MWI", coordinates: [34, -13.5] },
    { name: "BURUNDI", code: "BDI", coordinates: [29.5, -3.5] },
    { name: "DJIBOUTI", code: "DJI", coordinates: [43, 11.5] },
    { name: "EQ. GUINEA", code: "GNQ", coordinates: [10, 2] },
    { name: "GAMBIA", code: "GMB", coordinates: [-15, 13.5] },
    { name: "G-BISSAU", code: "GNB", coordinates: [-14.5, 12.2] },
    { name: "COMOROS", code: "COM", coordinates: [44, -12] },
    { name: "CABO VERDE", code: "CPV", coordinates: [-24, 16] },
];
            ...
            >
                ...
                >
                    ...
                    {mapTheme === "SOVEREIGNTY" && COUNTRY_LABELS.map((label, idx) => {
                        const countryData = countryDataMaster.find(d => d.country === label.code);
